...
proc create_root_design { parentCell } {
  ...
  set mipi_clk_hs_p [ create_bd_port -dir I mipi_clk_hs_p ]
  set mipi_clk_hs_n [ create_bd_port -dir I mipi_clk_hs_n ]
  set mipi_clk_lp_p [ create_bd_port -dir I mipi_clk_lp_p ]
  set mipi_clk_lp_n [ create_bd_port -dir I mipi_clk_lp_n ]
  set mipi_data_hs_p [ create_bd_port -dir I -from 1 -to 0 mipi_data_hs_p ]
  set mipi_data_hs_n [ create_bd_port -dir I -from 1 -to 0 mipi_data_hs_n ]
  set mipi_data_lp_p [ create_bd_port -dir I -from 1 -to 0 mipi_data_lp_p ]
  set mipi_data_lp_n [ create_bd_port -dir I -from 1 -to 0 mipi_data_lp_n ]
...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.C_HS_LINE_RATE {700} \
    CONFIG.C_HS_SETTLE_NS {100} \
    CONFIG.DPY_LINE_RATE {700} \
  ...
  # Create instance: rst_mm_clk_150, and set properties
  set rst_mm_clk_150 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_mm_clk_150 ]
  ...
  connect_bd_intf_net -intf_net axis_subset_conv_0_M_AXIS [get_bd_intf_pins axis_subset_conv_0/M_AXIS] [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins ps7_0_axi_periph/M04_AXI] [get_bd_intf_pins v_demosaic_0/s_axi_CTRL]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins ps7_0_axi_periph/M05_AXI] [get_bd_intf_pins v_gamma_lut_0/s_axi_CTRL]
  ...
  connect_bd_intf_net -intf_net v_gamma_lut_0_m_axis_video [get_bd_intf_pins v_gamma_lut_0/m_axis_video] [get_bd_intf_pins axis_subset_conv_0/S_AXIS]
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_50M/dcm_locked] [get_bd_pins rst_mm_clk_150/dcm_locked]
  ...
  connect_bd_net -net mipi_clk_hs_n_1 [get_bd_ports mipi_clk_hs_n] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_clk_hs_n]
  connect_bd_net -net mipi_clk_hs_p_1 [get_bd_ports mipi_clk_hs_p] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_clk_hs_p]
  connect_bd_net -net mipi_clk_lp_n_1 [get_bd_ports mipi_clk_lp_n] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_clk_lp_n]
  connect_bd_net -net mipi_clk_lp_p_1 [get_bd_ports mipi_clk_lp_p] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_clk_lp_p]
  connect_bd_net -net mipi_data_hs_n_1 [get_bd_ports mipi_data_hs_n] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_data_hs_n]
  connect_bd_net -net mipi_data_hs_p_1 [get_bd_ports mipi_data_hs_p] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_data_hs_p]
  connect_bd_net -net mipi_data_lp_n_1 [get_bd_ports mipi_data_lp_n] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_data_lp_n]
  connect_bd_net -net mipi_data_lp_p_1 [get_bd_ports mipi_data_lp_p] [get_bd_pins mipi_csi2_rx_subsyst_0/mipi_phy_if_data_lp_p]
  connect_bd_net -net mm_clk_150 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aclk] [get_bd_pins v_demosaic_0/ap_clk] [get_bd_pins v_gamma_lut_0/ap_clk] [get_bd_pins axis_subset_conv_0/aclk] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins rst_mm_clk_150/slowest_sync_clk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_clk_wiz_0_50M/ext_reset_in] [get_bd_pins rst_vid_clk_dyn/ext_reset_in] [get_bd_pins rst_mm_clk_150/ext_reset_in]
  connect_bd_net -net ref_clk_200 [get_bd_pins clk_wiz_0/clk_out3] [get_bd_pins mipi_csi2_rx_subsyst_0/dphy_clk_200M]
  ...
  connect_bd_net -net rst_clk_wiz_0_50M_peripheral_aresetn [get_bd_pins rst_clk_wiz_0_50M/peripheral_aresetn] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins video_dynclk/s_axi_aresetn] [get_bd_pins vtg/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aresetn]
  connect_bd_net -net rst_clk_wiz_0_50M_peripheral_reset [get_bd_pins rst_clk_wiz_0_50M/peripheral_reset]
  connect_bd_net -net rst_mm_clk_150_peripheral_aresetn [get_bd_pins rst_mm_clk_150/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins v_demosaic_0/ap_rst_n] [get_bd_pins v_gamma_lut_0/ap_rst_n] [get_bd_pins axis_subset_conv_0/aresetn] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aresetn]
  ...
  connect_bd_net -net s_axil_clk_50 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins rst_clk_wiz_0_50M/slowest_sync_clk] [get_bd_pins video_dynclk/s_axi_aclk] [get_bd_pins vtg/s_axi_aclk] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aclk]
  ...
  assign_bd_address -offset 0x43C40000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs v_gamma_lut_0/s_axi_CTRL/Reg] -force
